...
class InterviewTasksTest {
	...
	void getMaxWithNegativeTest() {
		...
		assertEquals(100, InterviewTasks.getMaxWithNegativePresentation1Pass(array));
		assertEquals(40, InterviewTasks.getMaxWithNegativePresentation1Pass(array1));
		assertEquals(-1, InterviewTasks.getMaxWithNegativePresentation1Pass(array2));
	}
